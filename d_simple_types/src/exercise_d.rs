...
fn main() {
    ...
    print_difference(coords1, coords2);   // Uncomment and finish this line;
    ...
    //
    let coords_arr: [f64;2] = [coords1, coords2];  // create an array literal out of parts of `coord` here
